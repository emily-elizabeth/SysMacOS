...
Begin DesktopWindow Window1
   ...
   Begin DesktopGroupBox GroupBox1
      ...
      Begin DesktopCanvas Canvas1
         ...
         Width           =   282
      End
      Begin DesktopPopupMenu iconSize
         AllowAutoDeactivate=   True
         Bold            =   False
         Enabled         =   True
         FontName        =   "System"
   ...
   Begin DesktopGroupBox GroupBox2
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Request User Attention"
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      FontUnit        =   0
      ...
      Begin DesktopButton Button3
         ...
         Bold            =   False
         Cancel          =   False
         Caption         =   "Request User Attention (Critical)"
         Default         =   False
         Enabled         =   True
         FontName        =   "System"
         FontSize        =   0.0
      ...
      Begin DesktopLabel Label1
         ...
         TabPanelIndex   =   0
         TabStop         =   True
         Text            =   "This only works when the application is in the background, so we use Timer.CallLater to allow you to move the application to the background."
         TextAlignment   =   0
         TextColor       =   &c000000
         Tooltip         =   ""
         Top             =   56
   ...
   Begin DesktopGroupBox GroupBox3
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Post User Notification"
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      FontUnit        =   0
      ...
      Visible         =   True
      Width           =   402
      Begin DesktopTextField NotificationTitle
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         ...
         Width           =   238
      End
      Begin DesktopTextField NotificationSubtitle
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
         ...
         Width           =   238
      End
      Begin DesktopTextField NotificationInformativeText
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
      ...
      Begin DesktopButton Button4
         ...
         Width           =   238
      End
      Begin DesktopTextField NotificationIdentifier
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub RequestAttention()
		  SysMacOS.RequestUserAttention
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub RequestAttentionCritical()
		  SysMacOS.RequestUserAttention TRUE
		End Sub
	#tag EndMethod
...
#tag Events Button3
	#tag Event
		Sub Pressed()
		  Timer.CallLater 2000, AddressOf self.RequestAttentionCritical
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events Button2
	#tag Event
		Sub Pressed()
		  Timer.CallLater 2000, AddressOf self.RequestAttention
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events Button4
